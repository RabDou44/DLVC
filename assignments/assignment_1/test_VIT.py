...
def test(args):
    ...
    model = DeepClassifier(VIT(num_transformer_layers=6,
    embed_dim=192,
    num_heads=3,
    patch_size=16,
    num_patches=4,
    ...
    results_file_path = Path(args.results_path) / f"{Subset.TEST.__str__()}_log_VIT_{args.num_epochs}_{dropout_str}_{augment_str}.csv"
