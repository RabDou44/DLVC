...
#from assignments.assignment_2.dlvc.wandb_logger import WandBLogger
...
class ImgSemSegTrainer(BaseTrainer):
    ...
    def train(self) -> None:
        ...
        for epoch_idx in range(self.num_epochs):
            ...
            print(f"[Epoch {epoch_idx}] Train Loss: {train_loss:.4f}, Train mIoU: {train_mIoU:.4f}")
            ...
            if epoch_idx % self.val_frequency == 0:
                ...
                print(f"[Epoch {epoch_idx}] Val   Loss: {val_loss:.4f}, Val   mIoU: {val_mIoU:.4f}")
